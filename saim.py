...
android_models=[]
try:
	xx = requests.get('https://github.com/saim8288/janu/blob/main/rajanu.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/saim8288/janu/blob/main/rajanu.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				os.system('xdg-open https://wa.me/+923176291071?text=')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def gmail():
		...
		clear()
		print('\033[1;37m example: saim, ali, sajjad, faizan\033[1;97m')
		linex()
